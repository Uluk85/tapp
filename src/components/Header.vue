  ...
  <header class="flex justify-between items-center py-4 px-6 bg-white border-b-4 border-primary">
    <div class="flex items-center">
      ...
      <div class="relative mx-4 lg:mx-0">
        ...
        <input class="w-32 sm:w-64 rounded-md py-2 pl-10 pr-4 border border-black" type="text" placeholder="Search" />
      </div>
    </div>
    ...
    <div class="flex items-center">
      ...
      <div class="relative">
        <button @click="dropdownOpen = !dropdownOpen"
          ...
          <img class="h-full w-full object-cover" src="/user_avatar.png" alt="Your avatar" />
        </button>
